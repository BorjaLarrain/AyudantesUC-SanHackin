                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-lg shadow-xl p-8">
                            ...
                            <div className="flex items-center gap-2 text-gray-500 text-sm mb-6">
                                ...
                                <span>Semestre {review.semester || 'N/A'}</span>
                                <span>•</span>
                            ...
                            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-gray-200">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-sm font-medium text-gray-700">Rango Salarial</h3>
                                    </div>
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h3 className="text-sm font-medium text-gray-700">Carga Horaria</h3>
                                    </div>
                                    <p className="text-2xl font-bold text-gray-900">
                                        {review.month_hourse || 0} horas
                                    </p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg shadow-xl p-6">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="text-lg font-semibold text-gray-900">Profesor/a</h2>
                            </div>
                            <p className="text-sm text-gray-600">
                                Información oculta (review anónima)
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow-xl p-6">
                            ...
                            <div className="space-y-3">
                                <div>
                                    <p className="text-sm font-medium text-gray-700">Facultad</p>
                                    <p className="text-sm text-gray-600">Ingeniería</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-700">Campus</p>
                                    <p className="text-sm text-gray-600">San Joaquín</p>
                                </div>
                            </div>
                        </div>

                        {/* Card de Call to Action */}
                        <div className="bg-blue-50 rounded-lg shadow-xl p-6">
